  ...
  <div class="container-xl container-md container-sm container container-md container-sm container mt-4">
    ...
    <section class="d-flex justify-content-center keranjang-belanja text-center">
      <div class="col-lg-4 col-md-6 col-sm-8 col-8 mb-5">
        ...
        <p class="mt-3">
          Anda Belum Memilih Ikan
        </p>
        <div class="mt-3">
          <a href="index.html"><button class="btn btn-primary rounded">Belanja Sekarang</button></a>
        </div>
      </div>
    </section>
  ...
  <div class="container-xl">
    ...
    <section class="keranjang-belanja mt-4">
      <div class="row">
        ...
        <div class="col-3">
          <p class="fs-5 fw-normal m-0">Ikan Tuna</p>
          <p class="fs-5 fw-bolder m-0">16.000/0.5kg</p>
        </div>
        <div class="col-3 jml-produk mb-2">
          <div class="kuantiti-produk text-center">
        ...
        <div class="col-3">
          <div class="text-center">
            <i class="fs-3 text-danger fas fa-trash-alt"></i>
          </div>
