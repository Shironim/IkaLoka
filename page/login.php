  ...
  <main id="root" class="mt-5">
    <div class="container">
      <div class="row justify-content-sm-center justify-content-center">
        <div class="col-lg-6 col-md-6 col-sm-10 col-10 align-self-center text-center mb-4">
          <div class="container col-10">
            <svg id="a5c16198-98a1-478b-8909-43624583dcf2" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
            max-width="400px" max-height="300px" viewBox="0 0 793 551.73152">
